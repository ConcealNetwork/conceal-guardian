...
.\tools\7z.exe a -r -ttar .\bin\linux\guardian-linux64.tar .\bin\linux\guardian-linux64 .\bin\linux\config.json .\bin\linux\exclude.txt .\bin\linux\ccx-guardian.service.template .\bin\linux\html
