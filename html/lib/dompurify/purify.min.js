...
!(function (e, t) {
  ...
  var V = (function t() {
    ...
    const o = (e) => t(e);
    if (((o.version = "3.0.5"), (o.removed = []), !n || !n.document || 9 !== n.document.nodeType))
    ...
    let ie = {};
    o.isSupported =
      "function" == typeof e && "function" == typeof Z && ee && void 0 !== ee.createHTMLDocument;
    const {
      MUSTACHE_EXPR: ae,
      ERB_EXPR: le,
      TMPLIT_EXPR: ce,
        ...
        if (!tt || tt !== e) {
          if (
            ...
            e.CUSTOM_ELEMENT_HANDLING &&
              ...
              (ye.attributeNameCheck = e.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
            e.CUSTOM_ELEMENT_HANDLING &&
            ...
            e.FORBID_CONTENTS && (Fe === He && (Fe = S(Fe)), N(Fe, e.FORBID_CONTENTS, et)),
            Me && (de["#text"] = !0),
    ...
    const mt = function (e) {
      ...
      pt = function (e) {
        ...
        return (
          e && n && r.insertBefore(l.createTextNode(n), r.childNodes[0] || null),
            ...
            !(
              (At(e) &&
                ((ye.tagNameCheck instanceof RegExp && E(ye.tagNameCheck, e)) ||
                  (ye.tagNameCheck instanceof Function && ye.tagNameCheck(e))) &&
                ((ye.attributeNameCheck instanceof RegExp && E(ye.attributeNameCheck, t)) ||
                  (ye.attributeNameCheck instanceof Function && ye.attributeNameCheck(t)))) ||
              ("is" === t &&
                ye.allowCustomizedBuiltInElements &&
      ...
      _t = function (e) {
        ...
        if (!a) return;
        const l = { attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: ge };
        for (i = a.length; i--; ) {
          t = a[i];
    ...
    return (
      (o.sanitize = function (e) {
        ...
        if (Ue) return e;
        if (ve) {
          if (xe) for (a = ne.call(t.ownerDocument); t.firstChild; ) a.appendChild(t.firstChild);
          else a = t;
