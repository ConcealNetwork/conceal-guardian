...
!(function (t, e) {
  ...
  class Dt extends W {
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding ? j.one(this._element, pt, () => this.cycle()) : this.cycle());
    }
    to(t) {
  ...
  class Ee extends q {
    ...
    dispose() {
      this._isAppended &&
        (j.off(this._element, ye), this._element.remove(), (this._isAppended = !1));
    }
    _getElement() {
      if (!this._element) {
  ...
  class ji extends W {
    ...
    hide() {
      if (
        ...
        if (
          (this._getTipElement().classList.remove($i), "ontouchstart" in document.documentElement)
        )
          for (const t of [].concat(...document.body.children)) j.off(t, "mouseover", _);
        ...
        if ("click" === e)
          ...
          j.on(this._element, t, this._config.selector, (t) => {
            ...
            j.on(this._element, i, this._config.selector, (t) => {
              const e = this._initializeOnDelegatedTarget(t);
              (e._activeTrigger["focusout" === t.type ? Di : Ii] = e._element.contains(
                t.relatedTarget,
              )),
                e._leave();
            });
  ...
  j.on(window, Vi, () => {
    for (const t of K.find('[data-bs-spy="scroll"]')) Zi.getOrCreateInstance(t);
  }),
    b(Zi);
  const ts = ".bs.tab",
    es = `hide${ts}`,
